...
class ZumperCollector(BaseCollector):
    ...
    def _detect_neighborhood(self, listing: Listing):
        ...
        elif zip_code in {"94108", "94109"} or "nob hill" in addr_lower or "nob hill" in hood:
            listing.neighborhood = "Nob Hill"
        elif zip_code in {"94105", "94107"} or "soma" in addr_lower or "soma" in hood or "south of market" in hood:
